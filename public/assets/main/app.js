 ...
 function makeRequest() {
   ...
   request.execute(function(response)  {
          ...
          //  vidURLHolder = '<div class="urlTouseonIframe" style="display:hidden;">' + vidURL + '</div>';
           ...
           $('.gmBody').append('<a id="thumbnailToVideo" class="thumbnailLoadsVideo" data-vid="'+ vidURL +'"  onclick="goThumbToVideo(this);">' + '<div class="gmThumbHolder">' + vidThumbimg + '<div class="gmThumbTitle" style="font-family:GalanoBold;">'+ vidTitle + '</div>' + '</a>' + '<div class="thumbDownloadButton">' + vidDownloadButton + '</div>' + '</div>');
           $('.gmVideoOptions').append('<div class="gmMainVidTitle">' + vidTitle +'</div>' + vidDownloadButton);
